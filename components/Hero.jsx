...
const Hero = () => {
  ...
  return (
    <div className=" h-[70vh] bg-cover">
      <div className=" flex items-center flex-col justify-start mt-36">
        <div>
        ...
        <div className="flex justify-center items-center mt-10">
          {account ? (
            <button
              className="p-2 font-custom-font-1 tracking-widest bg-yellow-500 rounded-xl w-20"
              onClick={async () => {
